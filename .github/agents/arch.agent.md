...
- **Rationale**: Architecture decisions require deep multi-system reasoning, pattern analysis, and long-term design impact assessment. Premium tier ensures the highest quality output for these critical decisions.
- **Downgrade**: For simple project overview generation, accept `modelTier=standard`.
